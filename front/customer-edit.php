...
<?php 
	...
	if (isset($_GET['customer_id'])) {
		...
		if ($result_set) {
			if (mysqli_num_rows($result_set) == 1) {
				...
				// user not found
				header('Location: customer-profile.php?err=user_not_found');	
			}
		} else {
			// query unsuccessful
			header('Location: customer-profile.php?err=query_failed');
		}
	}
	...
	if (isset($_POST['submit'])) {
		...
		$req_fields = array('customer_id', 'first_name', 'last_name', 'email', 'contact_number', 'address');
		$errors = array_merge($errors, check_req_fields($req_fields));

		// checking max length
		$max_len_fields = array('first_name' => 15, 'last_name' =>15, 'email' => 50, 'contact_number' => 20, 'address' => 100);
		...
		$query = "SELECT * FROM customer WHERE email = '{$email}' AND customer_id != {$customer_id} LIMIT 1";
		...
		if (empty($errors)) {
			...
			if ($result) {
				...
				header('Location: customer-profile.php?user_modified=true');
			} else {
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
								...
								<a href="customer-change-password.php?customer_id=<?php echo $customer_id; ?>">Change Password</a>
                            </div>
