...
<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$req_fields = array('supplier_id', 'first_name', 'last_name', 'email', 'contact_number', 'address');
		...
		$query = "SELECT * FROM supplier WHERE email = '{$email}' AND supplier_id != {$supplier_id} LIMIT 1";
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
								...
								<a href="supplier-change-password.php?supplier_id=<?php echo $supplier_id; ?>">Change Password</a>
                            </div>
